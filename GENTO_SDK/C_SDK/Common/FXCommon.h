...
#define FX_SDK_MINOR_VERSION 1UL /**< Minor version number */
...
typedef struct
{
    ...
    FX_CHAR m_ARM_FBK_Flange_DI;        ///< Flange DI signal
    FX_CHAR m_ARM_FBK_LowSpdFlag;       ///< Low speed indicator
    FX_CHAR m_ARM_FBK_TrajState;        ///< Trajectory execution state
    FX_CHAR m_pad[1];                   ///< Padding byte
} ARM_GET;
...
typedef struct
{
    ...
    FX_BOOL m_ARM_SET_SetTags[16];    ///< Set flags
