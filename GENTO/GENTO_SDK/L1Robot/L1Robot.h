...
extern "C"
{
     ...
     * 
     * @return FX_INT32 Link establishment result:
     ...
     */     
    FX_L1_SDK_API FX_INT32 FX_L1_System_Link(FX_UCHAR ip1, FX_UCHAR ip2, FX_UCHAR ip3, FX_UCHAR ip4, FX_INT32 *version, FX_UINT32 logSwitch);
    /**
     ...
     * 
     * @return FX_BOOL Reboot initiation result:
     *         - FX_TRUE: Reboot command accepted and will be executed
     *         - FX_FALSE: Reboot cannot be performed at this time
     * 
     ...
     * 
     * @return FX_INT32 The degrees of freedom for the specified control object:
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Error codes successfully retrieved and array populated
     *         - FX_FALSE: Failed to retrieve error codes, array contents are undefined
     * 
     * @note The function may return FX_TRUE even if no errors are present (all codes may be 0)
     ...
     * 
     * @return FX_UINT32 Bitmask indicating reset results:
     ...
     * 
     * @return FX_UINT32 Bitmask indicating emergency stop execution results:
     ...
     * 
     * @return FX_INT32 Transition result:
     *         - 0: Operation success
     *         - Negative values: Error codes:
     ...
     *           -8: Invalid input parameters
     */    
    FX_L1_SDK_API FX_INT32 FX_L1_State_SwitchToPositionMode(FXObjType obj_type, FX_UINT32 timeout, FX_DOUBLE vel_ratio, FX_DOUBLE acc_ratio);
    /**
     ...
     */
    FX_L1_SDK_API FX_INT32 FX_L1_State_SwitchToImpJointMode(FXObjType obj_type, FX_UINT32 timeout, FX_DOUBLE vel_ratio, FX_DOUBLE acc_ratio, FX_DOUBLE k[7], FX_DOUBLE d[7]);
    /**
     ...
     */
    FX_L1_SDK_API FX_INT32 FX_L1_State_SwitchToImpCartMode(FXObjType obj_type, FX_UINT32 timeout, FX_DOUBLE vel_ratio, FX_DOUBLE acc_ratio, FX_DOUBLE k[7], FX_DOUBLE d[7]);
    /**
     ...
     *                 Parameter names are case-sensitive unless otherwise specified
     *                 by the system implementation.
     * @param[out] value Pointer to an FX_INT32 variable where the parameter
     ...
     *                 Parameter names are case-sensitive unless otherwise specified
     *                 by the system implementation.
     * @param[out] value Pointer to an FX_FLOAT variable where the parameter
     *                   value will be stored if found. The pointer must not be NULL.
     *
     * @return FX_BOOL Returns #FX_TRUE if the parameter was successfully found
     *                  and its value retrieved. Returns #FX_FALSE if the parameter
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Terminal data cleared successfully
     *         - FX_FALSE: Failed to clear terminal data
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Data successfully sent to terminal
     *         - FX_FALSE: Failed to send data to terminal
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Brake lock command accepted and executed for specified axes
     *         - FX_FALSE: Failed to set brake lock state
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Brake unlock command accepted and executed for specified axes
     *         - FX_FALSE: Failed to unlock brakes
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Encoder offsets successfully reset for specified axes
     *         - FX_FALSE: Failed to reset encoder offsets
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Encoder errors successfully cleared for specified axes
     *         - FX_FALSE: Failed to clear encoder errors
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Sensor offset successfully cleared
     *         - FX_FALSE: Failed to clear sensor offset
     *
     * @note Setting an offset may affect control performance and should be done carefully
     */    
    FX_L1_SDK_API FX_BOOL FX_L1_Config_ClearAxisSensorOffset(FXObjType obj_type, FX_UINT32 axis_id);
    /**
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: All sensor offsets successfully cleared
     *         - FX_FALSE: Failed to clear sensor offsets
     * 
     * @note Setting an offset may affect control performance and should be done carefully
     */
    FX_L1_SDK_API FX_BOOL FX_L1_Config_ClearSensorOffset(FXObjType obj_type);
    /**
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Software limits successfully disabled for specified axes
     *         - FX_FALSE: Failed to disable software limits
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Trajectory data successfully configured
     *         - FX_FALSE: Failed to configure trajectory
     * 
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Position command accepted and will be executed
     *         - FX_FALSE: Failed to set position command
     */
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Force control parameters successfully set
     *         - FX_FALSE: Failed to set force control parameters
     */    
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Torque control parameters successfully set
     *         - FX_FALSE: Failed to set torque control parameters
     */    
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Velocity ratio successfully set
     *         - FX_FALSE: Failed to set velocity ratio
     */
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Acceleration ratio successfully set
     *         - FX_FALSE: Failed to set acceleration ratio
     */    
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Both velocity and acceleration ratios successfully set
     *         - FX_FALSE: Failed to set one or both ratios
     */    
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Joint stiffness coefficients successfully set
     *         - FX_FALSE: Failed to set joint stiffness coefficients
     */    
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Joint damping coefficients successfully set
     *         - FX_FALSE: Failed to set joint damping coefficients
     */   
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Joint stiffness and damping coefficients successfully set
     *         - FX_FALSE: Failed to set joint impedance coefficients
     */     
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Cartesian stiffness coefficients successfully set
     *         - FX_FALSE: Failed to set Cartesian stiffness coefficients
     */
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Cartesian damping coefficients successfully set
     *         - FX_FALSE: Failed to set Cartesian damping coefficients
     */    
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Cartesian stiffness and damping coefficients successfully set
     *         - FX_FALSE: Failed to set Cartesian impedance coefficients
     */    
     ...
     */    
    FX_L1_SDK_API FX_BOOL FX_L1_Runtime_SetToolK(FXObjType obj_type, FX_DOUBLE k[6]);
    /**
     ...
     *                  failed.
     */    
    FX_L1_SDK_API FX_BOOL FX_L1_Runtime_SetToolD(FXObjType obj_type, FX_DOUBLE d[10]);
    /**
     ...
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Tool stiffness and damping coefficients successfully set
     *         - FX_FALSE: Failed to set tool impedance coefficients
     */
    FX_L1_SDK_API FX_BOOL FX_L1_Runtime_SetToolKD(FXObjType obj_type, FX_DOUBLE k[6], FX_DOUBLE d[10]);
    /**
     ...
     * 
     * @param[in] p Array of 6 joint stiffness values (FX_DOUBLE) in appropriate
     *             units (typically Nm/Deg).
     * 
     * @param[in] d Array of 6 joint damping values (FX_DOUBLE) in appropriate
     *             units (typically Nm·s/Deg).
     * 
     * @return FX_BOOL Operation result:
     *         - FX_TRUE: Body P and D gains successfully set
     *         - FX_FALSE: Failed to set body control gains
     */    
     ...
     *                 - Bit 4: Lift
     * 
     * @return FX_UINT32 Bitmask indicating trajectory execution results:
     ...
     *                 - Bit 4: Lift
     * 
     * @return FX_UINT32 Bitmask indicating trajectory stop results:
