...
public:
	...
	/**
	 * @brief Initialize the planner for one robot arm.
	 ...
	 */
	FX_BOOL L0_OnInitEnv_SingleArm(FX_CHAR *env_path, FX_INT32 RobotSerial);
	 ...
	 */
	FX_BOOL L0_OnInitEnv_DualArm(FX_CHAR *env_path);
