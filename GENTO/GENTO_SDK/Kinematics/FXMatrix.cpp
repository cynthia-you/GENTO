...
FX_VOID SVD_CALP(FX_DOUBLE a[], FX_DOUBLE e[], FX_DOUBLE s[], FX_DOUBLE v[], FX_INT32 m, FX_INT32 n)
{
	FX_INT32 i, j, p, q;
	FX_DOUBLE d;
	if (m >= n)
...
FX_INT32 SVD_UAV(FX_DOUBLE a[], FX_INT32 m, FX_INT32 n, FX_DOUBLE u[], FX_DOUBLE v[], FX_DOUBLE eps, FX_INT32 ka)
{
	FX_INT32 i, j, k, l, it, ll, kk, ix, iy, mm, nn, iz, ml, ks;
...
FX_INT32 Cholesky(Matrix6 A, Matrix6 L, FX_INT32 n)
{
	FX_INT32 i, j, k;
	for (k = 0; k < n; k++) {
		FX_DOUBLE sum = 0;
